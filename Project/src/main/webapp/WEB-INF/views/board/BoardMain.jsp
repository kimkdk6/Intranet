										...
										<tbody>
											<tr>
												<td width="90%"
													...
													<a class="title_txt"
													href="${pageContext.request.contextPath}/board/BoardList.htm?boardcode=${bl.boardcode}">${bl.boardname}</a></td>
								...
								<td>
									...
									<table width="100%" id="docList" border="0" cellspacing="0"
										...
										<tbody>
											...
											<c:forEach items="${boards[bls.index]}" var="b"
												varStatus="bs">
												<tr bgcolor="#f9f9f9">
                                          ...
                                          ${bs.index+1}
													...
													<td
														...
														<a
														href="${pageContext.request.contextPath}/board/BoardDetail.htm?boardnum=${b.boardnum}">${b.boardtitle}</a>
													</td>
													<td align="center"
														style="padding: 2px 7px 0 7px; border-bottom: 1px #eaeaea solid;">
														<c:choose>
															<c:when test="${bl.boardcode==3}">
                                          Anonymous
                                       </c:when>
															<c:otherwise>
                                          ${b.userid}
													...
													<td align="center" class="date"
														style="border-bottom: 1px #eaeaea solid;">${b.boarddate}</td>
													<td align="center" class="date"
														style="padding: 0px 7px 0 0; border-bottom: 1px #eaeaea solid;">${b.boardcount}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
