...
$(function(){
	...
	function go_time() {
		...
		document.getElementById("clock").innerHTML = ampm + hours + ":"
				+ minutes + ":" + seconds;
...
<section class="content-header" onload="go_time()">
	<h1>
		Se7en <small><%=date%></small>
	</h1>
	<ol class="breadcrumb">
		<li style="font-size: 15px"><i class="fa fa-laptop"></i> &nbsp
			&nbsp <%=request.getRemoteAddr()%></li>
	</ol>
</section>
		...
		<div class="col-md-6">
			<div class="box">
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="float: left">${Checkname }님
						환영합니다.</h3>
				...
				<div class="box-body">
					<div class="info-box">
						...
						<img alt=""
							src="${pageContext.request.contextPath}/Upload/ProfilePhoto/${UserPhoto}"
							style="float: left; height: 90px; width: 90px;">
							...
							<table>
								<tr>
									<td>
											...
											<tr>
												<td><b>&nbsp&nbsp상신문서</b> : <a
													href="${pageContext.request.contextPath}/sign/SendsignsList.htm"><font
														color="#4e5fe8"><b><span>${getReceiveSigns}</span></b></font>건</a></td>
											</tr>
											<tr>
												<td><b>&nbsp&nbsp결재문서</b> : <a
													href="${pageContext.request.contextPath}/sign/ReceiveSignList.htm?type=2"><font
										...
										<table>
											<tr>
												<td style="padding-right: 20px;"><img id="checkinAjax"
													src="<%=request.getContextPath()%>/resources/img/bt_checkin.gif"
													style="cursor: pointer;"></td>
												<td
													style="border: 2px solid #e3e3e3; width: 100px; padding: 0px 0px 0px 25px;">
											...
											<tr>
												<td style="padding-right: 20px;"><img id="checkoutAjax"
													src="<%=request.getContextPath()%>/resources/img/bt_checkout.gif"
													style="cursor: pointer;"></td>
												<td
													style="border: 2px solid #e3e3e3; width: 100px; padding: 0px 0px 0px 25px;">
											...
											<tr id="commutecheck" style="visibility: hidden;">
												<td><span id="commute"></span></td>

												<td><input type="text" id="reason"
													style="border: 2px solid #e3e3e3; width: 100px; visibility: hidden;">
												</td>
												<td style="padding-left: 5px;">
													<button class="btn btn-block btn-default btn-sm"
														id="latebtton" name="late"
														style="padding-top: 2px; padding-bottom: 2px;">저장</button>
												</td>
											</tr>
					...
					<table class="table">
						<c:forEach items="${RecentlyBoard}" var="r">
							<tr>
								...
								<td style="padding-bottom: 19px"><a
									href="${pageContext.request.contextPath}/board/BoardDetail.htm?boardnum=${r.boardnum}">${r.boardtitle}</a></td>
								<td>${r.boarddate }</td>
							</tr>
						</c:forEach>
					</table>
					...
					<table class="table">
						<c:forEach items="${RecentlyNotice}" var="r">
							<tr>
								...
								<td style="padding-bottom: 21px"><a
									href="${pageContext.request.contextPath}/board/BoardDetail.htm?boardnum=${r.boardnum}">${r.boardtitle}</a></td>
								<td>${r.boarddate }</td>
							</tr>
						</c:forEach>
