    ...
    <td height="34" align="center" bgcolor="#f9f9f9" style="border-bottom:1px #d9d9d9 solid;padding:0 5px 0 5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody><tr>
          <td width="110" align="left"><table border="0" cellspacing="0" cellpadding="0">
              <tbody><tr>
                <td><a href="${pageContext.request.contextPath}/message/SendDelete.htm?msgnum=${message.msgnum}"><img src="../resources/img/message/bt_delete.gif" onclick="if(!confirm('쪽지를 삭제하시겠습니까?')) return false;"></a></td>
                <td width="5"></td>
                <td><a href="${pageContext.request.contextPath}/message/SendMessage.htm"><img src="../resources/img/message/bt_list.gif" border="0"></a></td>
              </tr>
          </tbody></table></td>
          <td width="" align="center" class="m_sp" style="font-weight:bold;color:#000;padding:3px 0 0 0;">보낸쪽지함</td>
          <td width="110">&nbsp;</td>
        </tr>
    </tbody></table></td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <td height="30" style="border-bottom:#eaeaea 1px solid;padding:7px 10px 4px 10px;" class="m_sp"><b><font color="#000000">${message.receiveid}</font></b>님에게 보낸 쪽지 </td>
  </tr>
  <tr>
