			...
			<tr>
                ...
                <td><a href="javascript:_keep()"><img src="../resources/img/message/bt_keep.gif" border="0"></a></td>
								...
								<td width="" align="center" class="m_sp"
									style="font-weight: bold; color: #000; padding: 3px 0 0 0;">받은쪽지함</td>
								<td width="110">&nbsp;</td>
							</tr>
						</tbody>
					</table></td>
				...
				<c:forEach items="${messagelist}" var="ml" varStatus="mls">
					<tr>
						...
						<td align="center" class="m_sp"
							style="padding: 2px 0 0 0; border-bottom: 1px #eaeaea solid;">${ml.sendid }</td>
						<td align="left" class="m_sp"
							style="padding: 2px 0 0 7px; border-bottom: 1px #eaeaea solid;">
							<span class="stip" title=""><a
								href="${pageContext.request.contextPath}/message/ReceiveDetail.htm?msgnum=${ml.msgnum}"
			...
			<tr>
				<td align="center" height="30" bgcolor="#ececec"
					...
					<c:choose>
						...
						<c:otherwise>
							<a
								href="${pageContext.request.contextPath}/message/ReceiveMessage.htm?cpage=${paging.start-1}">이전</a>
						</c:otherwise>
						...
						<c:choose>
							...
							<c:otherwise>
								<b><a
									href="${pageContext.request.contextPath}/message/ReceiveMessage.htm?cpage=${page}">[${page}]</a></b>
							</c:otherwise>
						</c:choose>
						...
						<c:when test="${paging.end < paging.finalPage}">
							<a
								href="${pageContext.request.contextPath}/message/ReceiveMessage.htm?cpage=${paging.end+1}">다음</a>
						</c:when>
						<c:otherwise>
