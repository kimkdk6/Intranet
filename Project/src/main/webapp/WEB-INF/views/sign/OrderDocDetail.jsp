								...
								<table width="100%" border="0" class="tbl_c9c9c9"
									...
									<tbody>
										<tr>
											...
											<td width="" style="padding: 0 0 0 12px;">2015-06-0009</td>
											<td width="365" rowspan="6" align="center" valign="top"
												...
												<form name="modProc" method="post"
													...
													<input type="hidden" name="docmgno" value="9778"> <input
														type="hidden" name="rtn_url"
														value="/approval/proc_wait_view.php?rtn_url=&amp;docmgno=9778">
										...
										<tr>
											...
											<td colspan="2" style="padding: 7px 0 7px 12px;">sss</td>
										</tr>
									</tbody>
								</table>
															...
															<td width="100%"
																...
																<table width="100%" cellspacing="0" cellpadding="0"
																	...
																	<tbody>
																		...
																		<tr height="27">
																			<td width="80%" align="center" class="title">세 액</td>
																			<td width="20%" align="right"
																				style="padding-right: 18px; color: #000000;"
																		...
																		<tr height="27">
																			<td width="80%" align="center" class="title">합 계</td>
																			<td width="20%" align="right"
																				style="padding-right: 18px; color: #000000;"
