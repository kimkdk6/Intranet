	...
	function divPrint() {
		...
		window
				.open(
						"PrintPage.htm",
						"print_open",
						"width=800,height=700,top=0,left=0,noresizable,toolbar=no,status=no,scrollbars=yes,directory=no");
														...
														<tbody>
															<tr>
																<td height="350" align="left" valign="top"
																	style="border: solid 1px #C0BFC1; padding: 8px 8px 5px 8px; border-top: 0">${draftingdoc.dracontent}
																</td>
															</tr>
