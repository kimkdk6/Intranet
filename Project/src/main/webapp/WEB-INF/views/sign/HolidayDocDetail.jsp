								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tbody>
										<tr>
											...
											<td width="5"></td>
											<td><a href="javascript:_docprint('9777')"><img
								...
								<table width="100%" border="0" class="tbl_c9c9c9"
									...
									<tbody>
										<tr>
											...
											<td width="" style="padding: 0 0 0 12px;">2015-06-0008</td>
											<td width="365" rowspan="6" align="center" valign="top"
												...
												<form name="modProc" method="post"
													...
													<input type="hidden" name="docmgno" value="9777"> <input
														type="hidden" name="rtn_url"
														value="/approval/proc_wait_view.php?rtn_url=&amp;docmgno=9777">
										...
										<tr>
											...
											<td colspan="2" style="padding: 7px 0 7px 12px;">s</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
																...
																<table id="detail_table" width="100%" cellspacing="0"
																	...
																	<tbody>
																		<tr height="35">
																			...
																			<td width="" class="item" align="left">2015년 06월
																				17일 부터 2015년 06월 18일 까지 &nbsp; <span id="vadate"
																				style="font-weight: bold; color: #000"> (총 2
																					일간) </span> <span style="font-weight: bold; color: #000">
																					(기안자의 현재 사용한 연차는 '0일', 잔여 연차는 '0일' 입니다.)</span>
																			</td>
																		</tr>
																		<tr height="35">
																			<td class="title">종류</td>
																			<td class="item" align="left">병가</td>
																		</tr>
																		<tr height="35">
																			<td class="title">사유</td>
																			<td class="item" align="left">s</td>
																		</tr>
																		<tr height="35">
										...
										<tr>
											<td align="left" valign="top" class="m_sp"
												style="padding: 8px 8px 8px 8px;">2015-06-17 19:12:04 -
												a1 상신</td>
										</tr>
									</tbody>
								</table>
