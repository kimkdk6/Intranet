...
<section class="content-header">
	...
	<div class="box">
		...
		<div class="box-body"
			style="padding-left: 50px; padding-right: 50px; padding-bottom: 20px; padding-top: 20px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<td height="30" bgcolor="#FFFCD5"
							style="border-bottom: 1px #EBEAF8 solid; border-top: 1px #EBEAF8 solid; padding: 0 0 0 12px;">
										...
										<tr bgcolor="#FEFDEE" height="23">
											...
											<td align="left"
												...
												href="${pageContext.request.contextPath}/admin/EmpEditAdmin.htm?userid=${emp.userid}">
													<b style="color: #4A5072">${emp.userid}</b>
											</a></td>
											<td align="left"
											...
											<td align="left"
												...
												<c:choose>
													<c:when test="${emp.empapprove == 0}">
														<a
															href="${pageContext.request.contextPath}/admin/EmpEditAdmin.htm?userid=${emp.userid}">
															<b style="color: #5769B0">${emp.ename} <font color="#FF2121">(대기중)</font></b>
														</a>
													</c:when>
													<c:otherwise>
														<a
															href="${pageContext.request.contextPath}/admin/EmpEditAdmin.htm?userid=${emp.userid}"><font
															color="gray"> <b> ${emp.ename} </b></font></a>
													</c:otherwise>
												</c:choose>
											</td>
											<td align="left"
